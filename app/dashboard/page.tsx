...
const FIELDS = [
  { id: 'chem_eng', name: 'Chemical Engineering', subs: ['Materials', 'Petrochemicals', 'Polymer Engineering', 'Process Engineering', 'Reaction Engineering', 'Thermodynamics'] },
  ...
  { id: 'biology', name: 'Biology', subs: ['Biochemistry', 'Cell Biology', 'Ecology', 'Evolutionary Biology', 'Genetics', 'Marine Biology', 'Microbiology', 'Molecular Biology', 'Physiology', 'Zoology'] },
