...
const FIELDS = [
  { id: 'engineering', name: 'Engineering', subs: ['Aerospace', 'AI & Robotics', 'Biomedical', 'Civil Engineering', 'Electrical', 'Mechanical', 'Nanotechnology', 'Software'] },
  ...
  { id: 'biology', name: 'Biology', subs: ['Cell Biology', 'Ecology', 'Evolutionary Biology', 'Genetics', 'Marine Biology', 'Microbiology', 'Molecular Biology'] },
  ...
  { id: 'chemistry', name: 'Chemistry', subs: ['Biochemistry', 'Medicinal Chemistry', 'Organic Chemistry', 'Physical Chemistry', 'Polymer Chemistry'] },
